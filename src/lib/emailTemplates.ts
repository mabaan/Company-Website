        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding:20px 0;">
          <tr><td align="center">
            <table width="600" cellpadding="0" cellspacing="0" border="0"
              ...
              <tr>
                <td style="padding:0 40px;">
                  <p style="font-size:16px;color:#555;line-height:1.5;">
                    Thank you for applying for the <strong style="color:#0054a4;">
                    ${role}</strong> role at GC International. We have received your CV and our HR team will review your application.
                  </p>
                  <p style="font-size:16px;color:#555;line-height:1.5;">
                    Good luck!
                  </p>
              ...
              <tr>
                <td style="padding:20px 40px;font-size:12px;color:#999;
                           text-align:center;">
                  <p style="margin:0;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding:20px 0;">
          <tr><td align="center">
            <table width="600" cellpadding="0" cellspacing="0" border="0"
              ...
              <tr>
                <td style="padding:0 40px;">
                  <h2 align="center" style="margin:0;font-size:20px;color:#333;">
                    New Application Received
                  </h2>
                  <p style="margin:8px 0 0;font-size:14px;color:#666;">
                    <strong>${data.firstName} ${data.lastName}</strong> applied for the
                    <strong>${data.role}</strong> role.
                  </p>
                </td>
              </tr>
              <tr>
                    ...
                    ${
                      data.linkedin
                        ? `<tr><td><strong>LinkedIn:</strong></td>
                               <td><a href="${data.linkedin}">${data.linkedin}</a></td></tr>`
                        : ``
                    }
                ...
                <td style="padding:0 40px 30px;">
                  <p style="font-size:14px;color:#555;">
                    ...
                    <a href="${data.resumeUrl}"
                       style="color:#0054a4;text-decoration:none;">
                      Download CV
                    </a>
                  </p>
                </td>
              ...
              <tr>
                <td style="padding:20px 40px 30px;font-size:12px;color:#999;
                           text-align:center;">
                  GC International FZCO, Dubai Airport Freezone, UAE
                </td>
              </tr>
          ...
          <tr><td align="center">
            <table width="600" cellpadding="0" cellspacing="0" border="0"
              ...
              <tr>
                <td style="padding:0 40px;">
                  <p style="font-size:16px;color:#555;line-height:1.5;">
                    Thank you for reaching out to GC International. We have received your message and will get back to you within 1–2 business days.
                  </p>
                </td>
              </tr>
              <tr>
...
// Notification to contact of a new contact form submission
            ...
            <table width="600" cellpadding="0" cellspacing="0" border="0"
              ...
              <tr>
                <td style="padding:0 40px;">
                  ...
                  <p style="margin:8px 0 0;font-size:14px;color:#666;">
                    <strong>${data.name}</strong> from <strong>${data.company}</strong> submitted a message.
                  </p>
                </td>
              </tr>
              <tr>
                <td style="padding:20px 40px;">
                  <table width="100%" cellpadding="4" cellspacing="0" border="0"
                    ...
                    <tr><td><strong>Submitted at:</strong></td><td>${data.submittedAt}</td></tr>
