        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding:20px 0;">
          <tr><td align="center">
            <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.1);">
              <tr><td align="center" style="padding:20px;"><img src="https://private-user-images.githubusercontent.com/131205438/468771106-5e8f247f-55bf-448b-a281-60ca7e394a6f.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmF3LmdpdGh1YnVzZXJjb250ZW50LmNvbSIsImtleSI6ImtleTUiLCJleHAiOjE3NTM0ODc1NTYsIm5iZiI6MTc1MzQ4NzI1NiwicGF0aCI6Ii8xMzEyMDU0MzgvNDY4NzcxMTA2LTVlOGYyNDdmLTU1YmYtNDQ4Yi1hMjgxLTYwY2E3ZTM5NGE2Zi5wbmc_.d0SJZT56UBHG1XaDut6yQl_iYNy7RK-QgP3vuiIbGvc" width="160" alt="GC International Logo" /></td></tr>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding:20px 0;">
          <tr><td align="center">
            <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.1);">
              <!-- Logo -->
              <tr><td align="center" style="padding:20px;"><img src="https://private-user-images.githubusercontent.com/131205438/468771106-5e8f247f-55bf-448b-a281-60ca7e394a6f.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmF3LmdpdGh1YnVzZXJjb250ZW50LmNvbSIsImtleSI6ImtleTUiLCJleHAiOjE3NTM0ODc1NTYsIm5iZiI6MTc1MzQ4NzI1NiwicGF0aCI6Ii8xMzEyMDU0MzgvNDY4NzcxMTA2LTVlOGYyNDdmLTU1YmYtNDQ4Yi1hMjgxLTYwY2E3ZTM5NGE2Zi5wbmc_.d0SJZT56UBHG1XaDut6yQl_iYNy7RK-QgP3vuiIbGvc" width="160" alt="GC International Logo" width="140" alt="GC International Logo" /></td></tr>
              ...
              <tr><td style="padding:20px 40px;">
                <table width="100%" cellpadding="4" cellspacing="0" border="0" style="font-size:14px;color:#444;">
                  <tr><td><strong>Email:</strong></td><td>${data.email}</td></tr> <br />
                  <tr><td><strong>Phone:</strong></td><td>${data.countryCode} ${data.phone}</td></tr> <br />
                  <tr><td><strong>Gender:</strong></td><td>${data.gender}</td></tr> <br />
                  <tr><td><strong>Nationality:</strong></td><td>${data.nationality}</td></tr> <br />
                  <tr><td><strong>DOB:</strong></td><td>${data.dob}</td></tr> <br />
                  <tr><td><strong>Visa Status:</strong></td><td>${data.visa}</td></tr> <br />
                  <tr><td><strong>Experience:</strong></td><td>${data.experience} years</td></tr> <br />
                  ${data.linkedin ? `<tr><td><strong>LinkedIn:</strong></td><td><a href="${data.linkedin}">${data.linkedin}</a></td></tr>` : ""} <br />
