...
const BlogCard = ({ post, className = "", index = 0 }) => {
  ...
  return /* @__PURE__ */ jsxs(
    "a",
    {
      ...
      tabIndex: 0,
      children: [
        post.imageUrl && /* @__PURE__ */ jsx("div", { className: "block mb-4 rounded-xl overflow-hidden", children: /* @__PURE__ */ jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs text-gray-500 mb-3", children: [
          post.categories && post.categories.length > 0 && /* @__PURE__ */ jsx("span", { className: "inline-flex gap-1 flex-wrap", children: post.categories.map((c) => /* @__PURE__ */ jsx(
            "span",
            {
        ...
        /* @__PURE__ */ jsx("h2", { className: "text-xl font-bold mb-1 text-[#003b71] group-hover:text-[#e41f26] transition", children: post.title }),
        post.author && /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-600 mb-3", children: [
          "by ",
          post.author
        ] }),
        post.body && /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden max-h-16 mb-4", children: [
          /* @__PURE__ */ jsx(PortableText, { value: post.body }),
          /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute bottom-0 left-0 w-full h-8 bg-gradient-to-t from-white" })
        ] })
      ]
    }
  );
