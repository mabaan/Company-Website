...
function applicantConfirmation({
  firstName,
  role
}) {
  return {
            ...
            <td align="center">
              <div class="container">
                ...
                <div class="footer">
                  ...
                  <p>&copy; ${(/* @__PURE__ */ new Date()).getFullYear()} GC International. All rights reserved.</p>
                </div>
              </div>
            </td>
          </tr>
...
function contactAcknowledgement({ name }) {
  return {
...
async function sendMail(opts) {
  ...
  console.log("✅ Mailgun API responded");
  return result;
}

export { contactNotification as a, applicantConfirmation as b, contactAcknowledgement as c, hrNotification as h, sendMail as s };
