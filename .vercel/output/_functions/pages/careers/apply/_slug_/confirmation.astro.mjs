...
import { b as base, A as APPLICATIONS_TABLE } from '../../../../chunks/airtable_BFbnGfKN.mjs';
import { b as applicantConfirmation, h as hrNotification, s as sendMail } from '../../../../chunks/mailgunClient_DdzYW0hS.mjs';
...
const $$Confirmation = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const [newRecord] = await base(APPLICATIONS_TABLE).create([
    {
      fields: {
  ...
  try {
    ...
    await sendMail({
      ...
      bcc: `${process.env.MAIL_CONTACT},${process.env.MAIL_MANAGEMENT}`,
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$BaseLayout, { "title": `Application Submitted | ${job.title}`, "description": `Your application for ${job.title} has been submitted.`, "ogTitle": `Application Submitted | ${job.title}`, "ogDescription": `Thank you for applying to GC International.`, "ogUrl": Astro2.url.href }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="pt-32 pb-12 px-4 min-h-[70vh] flex flex-col items-center">  <div class="w-full max-w-4xl -mt-8 pt-8"> ${renderComponent($$result2, "ProgressSteps", ProgressSteps, { "currentStep": 3, "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/haiderraza/Desktop/GitHub/Company-Website/src/components/ProgressSteps.tsx", "client:component-export": "default" })} </div>  <div class="flex-1 flex flex-col items-center justify-center w-full"> <div class="w-full max-w-2xl mt-10 bg-white shadow-xl rounded-2xl px-6 sm:px-10 py-10 text-center border border-gray-100"> <img src="https://res.cloudinary.com/dxrwnc5g4/image/upload/v1754148641/gcintle/resume/submitted.svg" alt="Submitted" class="mx-auto mb-5 h-14 w-14 object-contain"> <h1 class="text-3xl sm:text-4xl font-extrabold text-[#003b71] mb-4">Application Submitted</h1> <p class="text-lg mb-2">
Thank you for applying to <span class="font-semibold text-[#0054a4]">${job.title}</span> at GC International.
</p> <p class="text-gray-600 mb-8">
We have sent you a confirmation email.<br>
Our team will review your application and get back to you soon.
</p> <a href="/careers" class="inline-block bg-[#0054a4] hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold text-base transition-colors">
View Other Openings
</a> </div> </div> </section> ` })}`;
}, "/Users/haiderraza/Desktop/GitHub/Company-Website/src/pages/careers/apply/[slug]/confirmation.astro", void 0);

const $$file = "/Users/haiderraza/Desktop/GitHub/Company-Website/src/pages/careers/apply/[slug]/confirmation.astro";
